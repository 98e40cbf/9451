 ...
 *
 */
public class ApplyQuickPayFrom extends BaseObject {
    ...
    @DecimalMax(value = "10000000.00", message = "支付金额不能大于10000000.00")
    ...
    public ApplyQuickPayFrom setAmount(BigDecimal amount) {
        this.amount = amount;
        return this;
    }
    ...
    public ApplyQuickPayFrom setOrigin(String origin) {
        this.origin = origin;
        return this;
    }
}
