...
public class InvestService extends BaseService {
    ...
    public TradeResponseDTO invest(TradeDTO tradeDTO) {
        ...
        BigDecimal interest = DecimalUtil
                .format(ArithmeticUtils.arithmeticInterest(tradeDTO.getInvestAmount().doubleValue(),
                        product.getDeadline(), product.getAnnualRate().doubleValue(), 1));
