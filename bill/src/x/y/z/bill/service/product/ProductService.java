...
public class ProductService extends BaseService {
    ...
    public void productSoldOut(Long productId) {
        ...
        BigDecimal stillInterest = DecimalUtil.format(ArithmeticUtils.arithmeticInterest(
                product.getAmount().doubleValue(), product.getDeadline(), product.getAnnualRate().doubleValue(), 1));
